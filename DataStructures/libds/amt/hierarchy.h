...
namespace ds::amt {
	...
	public:
		...
		PreOrderHierarchyIterator beginPreAt(BlockType* t);
	...
	template<typename BlockType>
	auto Hierarchy<BlockType>::DepthFirstIterator::getBlock() -> BlockType*
	{
		currentPosition_->currentNodeProcessed_ = true;
	...
	template <typename BlockType>
	typename Hierarchy<BlockType>::PreOrderHierarchyIterator Hierarchy<BlockType>::beginPreAt(BlockType* t)
	{
		return (++PreOrderHierarchyIterator(this, t));
	}
