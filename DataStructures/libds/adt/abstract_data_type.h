...
namespace ds::adt {
    ...
    template<typename T>
    AbstractDataStructure<T>::AbstractDataStructure(amt::AMT* memoryStructure) : memoryStructure_(memoryStructure) {}

    template<typename T>
    AbstractDataStructure<T>::AbstractDataStructure(amt::AMT* memoryStructure, const AbstractDataStructure& other) : AbstractDataStructure(memoryStructure)
    {
        assign(other);
    }
